          ...
          <ScrollInView>
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <p className="mt-5 text-[15px] leading-relaxed text-[#5a555d]">
                {isEn
                  ? 'A carefully paced cycle with milestones you can see and plan around.'
                  : '节奏清晰、节点可预期的疗程。'}
              </p>
              <div className="mt-6 flex flex-wrap justify-center gap-6 text-center">
                ...
                <div className="flex flex-col items-center gap-1">
                  <span className="text-2xl font-semibold text-[#a63655]">
                    {isEn ? service.processSteps[0]?.durationEn ?? '10-14 days' : service.processSteps[0]?.durationZh ?? '10-14天'}
                  </span>
                  <span className="text-[11px] uppercase tracking-[0.24em] text-[#6c757d]">
                    {isEn ? 'stimulation' : '促排'}
                  </span>
                ...
                <div className="flex flex-col items-center gap-1">
                  <span className="text-2xl font-semibold text-[#a63655]">
                    {isEn ? service.processSteps[1]?.durationEn ?? '20-30 minutes' : service.processSteps[1]?.durationZh ?? '20-30分钟'}
                  </span>
                  <span className="text-[11px] uppercase tracking-[0.24em] text-[#6c757d]">
                    {isEn ? 'retrieval' : '取卵'}
                  </span>
