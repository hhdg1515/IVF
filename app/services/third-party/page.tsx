          ...
          <ScrollInView>
            <div className="mx-auto max-w-3xl text-center mb-16">
              ...
              <p className="mt-5 text-[15px] leading-relaxed text-[#5a555d]">
                {isEn
                  ? 'A long journey made manageable with a clear map and steady coordination.'
                  : '旅程较长，但有清晰路线与持续协调。'}
              </p>
              <div className="mt-6 flex flex-wrap justify-center gap-6 text-center">
                ...
                <div className="flex flex-col items-center gap-1">
                  <span className="text-2xl font-semibold text-[#a63655]">
                    {isEn ? service.processSteps[1]?.durationEn ?? '1-3 months' : service.processSteps[1]?.durationZh ?? '1-3个月'}
                  </span>
                  <span className="text-[11px] uppercase tracking-[0.24em] text-[#6c757d]">
                    {isEn ? 'matching' : '匹配'}
                  </span>
                ...
                <div className="flex flex-col items-center gap-1">
                  <span className="text-2xl font-semibold text-[#a63655]">
                    {isEn ? service.processSteps[4]?.durationEn ?? '10 months' : service.processSteps[4]?.durationZh ?? '10个月'}
                  </span>
                  <span className="text-[11px] uppercase tracking-[0.24em] text-[#6c757d]">
                    {isEn ? 'pregnancy' : '孕期'}
                  </span>
